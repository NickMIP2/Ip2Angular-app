...
export class ThemedetailCardsComponent implements OnInit {
  ...
  public card1: Card = {title: 'Kaart 1', description: 'De eerste kaart', image: '', categories: [this.category1, this.category2, this.category2, this.category2, this.category2]};
